<template>
  <div class="goods-box2">
    ...
    <div class="goods" v-for="(item, index) in cgoods" :key="index"
      ...
      <img v-if="item.picture" :src="item.picture" class="goods-img" />
      <img v-else src="../assets/img/wutu.gif" class="goods-img" />
      <div class="info">
...
export default {
  ...
  methods: {
    detailsClick(item) {
      //跳转到详情页，并带商品的id
      this.$router.push(`/home/details?orderId=${item}`);
    },
    handleSearch(){
